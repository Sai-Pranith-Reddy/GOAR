...
public class NavigationController : MonoBehaviour
{
    ...
    public void ArrivedAtDestination()
    {
        ...
        // Explicitly call the correct method
        if (AudioNavigationManager.Instance != null)
        {
            AudioNavigationManager.Instance.PlayPriorityClip(
    AudioNavigationManager.Instance.DestinationReached
);
        }
    }
